	...
	<script type="text/javascript">
		var treeMenu = [
                ...
                },
                {
                    ...
                    link : "rooms/Room_query.action"
                },
                {
                    level : 2,
                    name : "房间总览",
                    ico : "images/icon_default.gif",
                    link : "rooms/Room_status.action"
                },
                {
                    level : 2,
                    name : "我的房间",
                    ico : "images/icon_default.gif",
                    link : "members/Member_queryMe.action"
                },
                {
                    level : 1,
                    name : "人员管理"
                },
                {
                    ...
                    name : "会员列表",
                    ico : "images/icon_default.gif",
                    link:"admins/Admin_queryMB.action"
                },
                {
                    level : 2,
                    name : "员工列表",
                    ico : "images/icon_default.gif",
                    link:"employees/Employee_queryAll.action"
                },
                {
                    level : 1,
                    name : "信息管理"
		...
		<script type="text/javascript">
            ...
            for (var i = 0; i < treeMenu.length; i++)
            {
	            ...
	            if (item.link != null && item.link != "")
	            {
		            ...
		            {
			            tree
			                    .add (count, pLevelIdArray[itemLevel], item.name, item.link, null, null, item.ico,
			                            item.ico);
		            }
		            else
		            {
